...
layui.define(['jquery', 'form'], function(exports){
    ...
    var obj = {
        ...
        //选中的展开
        selectOpen: function(dst){
             $(dst).find('.authtree-checkitem:checked').parents('.auth-child').slideDown('fast');
             $(dst).find('.authtree-checkitem:checked').prev('.auth-icon').addClass('active').html(obj.openIconContent)
